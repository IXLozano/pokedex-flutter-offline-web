...
class PokemonRemoteDataSourceImpl implements PokemonRemoteDataSource {
  ...
  @override
  Future<PokemonListResponseDto> getPokemonPage({required int limit, required int offset}) async => //
  _execute(
    () async => await _dio
  ...
  @override
  Future<PokemonDetailDto> getPokemonDetail(int id) async => _execute(
    () async => await _dio
        .get('pokemon/$id')
  ...
  Future<T> _execute<T>(Future<T> Function() action) async {
    try {
      ...
      throw ParsingException(message: 'Invalid response');
    }
  }
}
